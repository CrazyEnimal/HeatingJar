...
// pin 7 - Nie-PWM sterowanie wentylatorem chłodzenia układu
// pin 8 - Nie-PWM dioda grzania / błędu
// pin 9 - Nie-PWM test-button
...
void loop() {
  if((temperatura(analogRead(A0)) >= 125.00 || temperatura(analogRead(A1)) >= 50.00) && (digitalRead(9) == LOW)){
    overheat_protection();
  }
